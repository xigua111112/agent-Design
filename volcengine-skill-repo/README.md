...
A Claude Code skill that enables Claude to generate production-grade UI following the **Volcengine (火山引擎) / Huoshan Design System**, built on **shadcn/ui v4** architecture.
...
- Compose components using **CVA + cn() + data-slot** patterns from shadcn/ui v4
...
- **Component framework:** shadcn/ui v4
