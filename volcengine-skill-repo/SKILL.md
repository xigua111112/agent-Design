...
description: "Use this skill when building UI components, pages, or applications that follow the Volcengine (火山引擎) / Huoshan Design System. Triggers include: any request to build dashboards, admin panels, data tables, forms, or UI components using the Volcengine or Huoshan design language; references to shadcn/ui v4 with Huoshan tokens; requests involving Volcengine color tokens, typography scale, sidebar layouts, or component patterns. Covers layout models, color system, typography, component architecture, states, interactions, and anti-patterns."
---

# Volcengine Design System Skill

火山引擎设计系统参考规范，基于 shadcn/ui v4 架构。圆角 / 字体 / 色彩 token 均已替换为 Huoshan Design System 标准值。

> Component structure derived from shadcn/ui v4. All design tokens (radius, typography, color) use Volcengine Design System standard values.
